<template>
    <div class="content">
        ...
        <div>
            <div id="itemList">
                <div class="timelineItem" v-for="(item,index) in techsData" :key="index">
                ...
                <div class="listButtonFix">
                    <div class="loading">
                        <img v-if="techsData.length < 60" src="~/assets/images/loading.gif" alt="">
...
export default {
    ...
    methods: {
        initData() {
            ...
            this.oldestOrder = UTCToSec(this.techsData[this.techsData.length - 1].publishDate);
        },
        initMethods() {
             // 判断   上滚动 / 下滚动
            var p=0,t=0; 
        ...
        loadMoreData() {
            getAPI.techsData({
                ...
                // 加载更多数据
                this.techsData = this.techsData.concat(res.data.data);
                this.initData();
            });
        }
    },
